  ...
  const body = (
    <>
      <Section heading="Summary">
        <Paragraph>
          Over {label}, Techstersol recorded {formatPkr(kpis.periodEarning)} in
          net earning against {formatPkr(totalExpenseLike)} allocated toward
          expenses, investment, and donations combined. Team payments —
          outsourced work and logged hours paid outside a booked earning — made
          up {teamPayRatio.toFixed(1)}% of gross earning for the period.
        </Paragraph>
        <Paragraph>
