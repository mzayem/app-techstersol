  ...
  return (
    <main
      ...
      className={cn(
        ...
        // without it, a wide table's intrinsic content width bubbles up
        // through this flex row and widens the whole page instead of being
        // contained by the table's own `overflow-x-auto` wrapper.
...
function SidebarMenuSkeleton({
  ...
  // Random width between 50 to 90% — computed only after mount, since a
  // value from Math.random() would otherwise differ between the server-
  // rendered HTML and the client's own render, causing a hydration mismatch.
