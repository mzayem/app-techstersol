...
import { getPayslipForVerification } from "@/actions/team/payslip-queries";
...
// (app/verify/[id]/page.tsx) — same tokens, markup, and fonts — adapted for
// payslip fields.
const STYLES = `
  .tsv-root {
    --tsv-bg: #08080a;
...
export default async function VerifyPayslipPage({
  ...
  const payslip = await getPayslipForVerification(id);
      ...
      <div className="tsv-wrapper">
        <div className="tsv-card">
          ...
          <p className="tsv-subtitle">
            This page verifies the authenticity of the issued payslip.
          </p>
          ...
          {!payslip ? (
            ...
            <>
              <div className="tsv-verify-box">
                ...
                <Row label="Payslip No." value={formatPayslipNumber(payslip.number)} />
                <Row label="Paid To" value={payslip.teamMemberName} />
                <Row
                  label="Period"
