      ...
      <div className="tsv-wrapper">
        <div className="tsv-card">
          ...
          <p className="tsv-subtitle">
            This page verifies the authenticity and assignment details of the issued invoice.
          </p>
            ...
            <>
              <div className="tsv-verify-box">
                ...
                <Row
                  label="Status"
                  value={
                    <span className={"tsv-status" + (isPaid ? "" : " tsv-status--unpaid")}>
                ...
                {isPaid && invoice.paidOn && (
                  <>
                    <Row label="Payment Date" value={formatDate(invoice.paidOn)} />
                    <Row
                      label="Paid On"
              ...
              <p className="tsv-footer-note">
                Verification generated by Techstersol. Any modification to the invoice
