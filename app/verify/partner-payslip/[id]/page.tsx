          ...
          {!payslip ? (
            ...
            <>
              <div className="tsv-verify-box">
                ...
                <Row
                  label="Payslip No."
                  value={formatPartnerPayslipNumber(payslip.number)}
                />
                ...
                {payslip.projectName && (
                  <Row label="Project" value={payslip.projectName} />
                )}
                <Row
                  label="Amount"
                  value={`${payslip.amount.toLocaleString()} PKR`}
                />
              </div>
              ...
              <p className="tsv-footer-note">
                ...
                payslip invalidates this verification reference.
              </p>
            </>
          )}
